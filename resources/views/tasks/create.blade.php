...
@section('content')
    <!-- Page heading -->
    <h1 class="text-3xl font-bold text-gray-800 mb-4">Create Task</h1>
    <!-- Task creation form -->
    <form action="{{ route('tasks.store') }}" method="POST" class="bg-white shadow-md rounded px-6 py-6 mb-4">
        @csrf
        <!-- Title field -->
        <div class="mb-4">
